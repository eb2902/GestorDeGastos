  ...
  return (
    <div className="flex flex-col h-full p-6 lg:p-8 bg-[#020617] overflow-y-auto">
      ...
      <nav className="space-y-2 flex-1">
        ...
        <div
          className="flex items-center gap-4 px-5 py-4 rounded-2xl border border-transparent text-slate-700 cursor-not-allowed select-none"
          title="Próximamente disponible"
        >
          <div className="opacity-30">
            <PieChart size={20} />
          </div>
          <span className="font-bold text-sm tracking-tight">Estadísticas</span>
          <span className="ml-auto text-[9px] font-black uppercase tracking-widest text-slate-600 bg-slate-800/60 px-2 py-0.5 rounded-full">
            Pronto
          </span>
        </div>
